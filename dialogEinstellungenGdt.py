...
class EinstellungenGdt(QDialog):
    def __init__(self, configPath):
        ...
        self.idInrGdt = configIni["GDT"]["idinrgdt"]
        self.idPraxisEdv = configIni["GDT"]["idpraxisedv"]
        self.kuerzeltInrGdt = configIni["GDT"]["kuerzelinrgdt"]
        ...
        labelInrGdt = QLabel("InrGDT:")
        labelInrGdt.setStyleSheet("font-weight:normal")
        ...
        self.lineEditInrGdtId = QLineEdit(self.idInrGdt)
        self.lineEditInrGdtId.setStyleSheet("font-weight:normal")
        self.lineEditInrGdtId.setEnabled(False)
        self.lineEditPraxisEdvId = QLineEdit(self.idPraxisEdv)
        self.lineEditPraxisEdvId.setStyleSheet("font-weight:normal")
        groupboxLayoutG.addWidget(labelInrGdt, 0, 0)
        groupboxLayoutG.addWidget(self.lineEditInrGdtId, 0, 1)
        ...
        labelInrGdtKuerzel = QLabel("InrGDT:")
        labelInrGdtKuerzel.setStyleSheet("font-weight:normal")
        labelPraxisEdvKuerzel = QLabel("Praxis-EDV:")
        labelPraxisEdvKuerzel.setStyleSheet("font-weight:normal")
        self.lineEditInrGdtKuerzel = QLineEdit(self.kuerzeltInrGdt)
        self.lineEditInrGdtKuerzel.textChanged.connect(self.kuerzelGeaendert) # type:ignore
        self.lineEditInrGdtKuerzel.setStyleSheet("font-weight:normal")
        self.lineEditInrGdtKuerzel.setEnabled(False)
        ...
        self.labelImportDateiname = QLabel("Import-Dateiname: " + self.lineEditInrGdtKuerzel.text() + self.lineEditPraxisEdvKuerzel.text() + ".gdt")
        self.labelImportDateiname.setStyleSheet("font-weight:normal")
        self.labelExportDateiname = QLabel("Export-Dateiname: " + self.lineEditPraxisEdvKuerzel.text() + self.lineEditInrGdtKuerzel.text() + ".gdt")
        self.labelExportDateiname.setStyleSheet("font-weight:normal")
        groupboxLayoutG.addWidget(labelInrGdtKuerzel, 0, 0)
        groupboxLayoutG.addWidget(self.lineEditInrGdtKuerzel, 0, 1)
        ...
        self.lineEditInrGdtId.setFocus()
        self.lineEditInrGdtId.selectAll()

    def kuerzelGeaendert(self):
        kuerzelInrGdt = self.lineEditInrGdtKuerzel.text()
        kuerzelPraxisEdv = self.lineEditPraxisEdvKuerzel.text()
        self.labelImportDateiname.setText("Import-Dateiname: " + kuerzelInrGdt + kuerzelPraxisEdv + ".gdt")
        self.labelExportDateiname.setText("Export-Dateiname: " + kuerzelPraxisEdv + kuerzelInrGdt + ".gdt")
