...
class UeberInrGdt(QDialog):
    def __init__(self):
        ...
        labelHilfe = QLabel("<span style='color:rgb(0,0,200);font-weight:bold'>Hilfe:</span><br><a href='https://github.com/retconx/inrgdt/wiki'>InrGDT Wiki</a>")
        labelHilfe.setTextFormat(Qt.TextFormat.RichText)
        labelHilfe.linkActivated.connect(self.githubWikiLinkGeklickt) # type: ignore
        labelSpende = QLabel("<span style='color:rgb(0,0,200);font-weight:bold'>Spende:</span><ul style='margin:0px'><li style='margin-left:-20px'i>Bankverbindung:<ul style='margin:0px'><li style='margin-left:-20px'>Kontoinhaber: Fabian Treusch</li><li style='margin-left:-20px'>IBAN: DE45 3006 0601 0507 5146 97</li><li style='margin-left:-20px'>BIC:DAAEDEDDXXX<br />(Deutsche Apotheker- und Ärztebank)</li></ul></li><li style='margin-left:-20px'>Gerne werden auch <a href='https://gdttools.de/inrgdt.php#spende'>Spenden in Bitcoin</a> akzeptiert.</li></ul>")
